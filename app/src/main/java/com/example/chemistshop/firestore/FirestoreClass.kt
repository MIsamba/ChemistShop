package com.example.chemistshop.firestore
...
import com.example.chemistshop.model.*
import com.example.chemistshop.ui.activities.*
import com.example.chemistshop.ui.fragment_bottom.DashboardFragment
import com.example.chemistshop.ui.fragment_bottom.ProductsFragment
import com.example.chemistshop.util.Constants
...
class FirestoreClass {
            ...
            .addOnSuccessListener { document ->
                ...
                val sharedPreferences =
                    activity.getSharedPreferences(
                        Constants.MYSAVE_PREFERENCES,
                        Context.MODE_PRIVATE
                    )

                // Create an instance of the editor which is help us to edit the SharedPreference.
                val editor: SharedPreferences.Editor = sharedPreferences.edit()
                //key logged username and value hello new
                editor.putString(
    ...
    //run fire store collection for all products
    ...
    fun updateAllDetails(activity: CheckoutActivity, cartList: ArrayList<Cart>, order: Order) {
        ...
        for (cart in cartList) {
            ...
            val documentReference = mFireStore.collection(Constants.CART)
                .document(cart.id)
