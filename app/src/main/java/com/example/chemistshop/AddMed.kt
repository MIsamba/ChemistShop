    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        private fun saveEmployee() {
            ...
            if (isValid) {
                ...
                values.put(ChemMedDBContract.MedicineEntry.COLUMN_NAME, name)
                values.put(ChemMedDBContract.MedicineEntry.COLUMN_DESIGNATION, designation)
                values.put(ChemMedDBContract.MedicineEntry.COLUMN_DOB, dob)

                val result = db.insert(ChemMedDBContract.MedicineEntry.TABLE_NAME, null, values)
