...
import com.example.chemistshop.adapter.MyProductsListAdapter
import com.example.chemistshop.firestore.FirestoreClass
import com.example.chemistshop.model.Product
import com.example.chemistshop.ui.activities.AddProductActivity
...
class ProductsFragment : BaseFragment() {
    ...
    // T Override the onCreateOptionsMenu function and inflate the Add Product menu.
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.action_add_product) {
            ...
            startActivity(Intent(activity, PrescriptionFragment::class.java))
    ...
    fun successProductsListFromFireStore(productsList: ArrayList<Product>) {
        hideProgressDialog()
        //adding items from array to the layout
