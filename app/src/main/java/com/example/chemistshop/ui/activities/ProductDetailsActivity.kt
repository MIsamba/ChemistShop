...
import com.example.chemistshop.firestore.FirestoreClass
import com.example.chemistshop.model.Cart
import com.example.chemistshop.model.Product
import com.example.chemistshop.util.Constants
import com.example.chemistshop.util.GlideLoader
...
class ProductDetailsActivity : BaseActivity(), View.OnClickListener {
    ...
    /**
     * This function is auto created by And id when the Activity Class is created.
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupActionBar()
//for owner hidding add to cart and go to cart function
...
//logic for checking stock quantinty
        if(product.stock_quantity.toInt() == 0){

            // Hide Progress dialog.
            //hideProgressDialog() //noted incase of error
